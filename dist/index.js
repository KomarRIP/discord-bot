...
client.once("ready", () => {
    log.info({ botUserId: client.user?.id, botTag: client.user?.tag }, "Bot ready");
    ...
    registerSlashCommands({
        ...
        .then(() => log.info({ scope: guildId ? "guild" : "global", guildId: guildId ?? null, count: commands.length }, "Slash commands registered"))
